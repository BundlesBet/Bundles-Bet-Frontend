...
import type { BundToken, BundTokenInterface } from "../BundToken";
...
export class BundToken__factory {
  static readonly abi = _abi;
  static createInterface(): BundTokenInterface {
    return new utils.Interface(_abi) as BundTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BundToken {
    return new Contract(address, _abi, signerOrProvider) as BundToken;
  }
}
